...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="TemplateFrontend/css/profUstyle.css">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav ml-auto mr-4">
          <li class="nav-item active">
            <a class="nav-link" href="dashboardDoctor">Home<span class="sr-only">(current)</span></a>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="#about">Chat</a>
          </li>

          <li class="nav-item dropdown">
            <a class="nav-link" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Service</a>
          ...
          <li class="nav-item dropdown">
            <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Notification</a>
              ...
              <div class="list-group list-group-flush">
                <a href="#!" class="list-group-item list-group-item-action">
                  <div class="row align-items-center">
                    <div class="col-auto">
                      <!-- Avatar -->
                      <img alt="Image placeholder" src="TemplateFrontend/img/anjing.jpg" class="avatar rounded-circle">
                    </div>
                    <div class="col ml--2">
          ...
          <ul class="navbar-nav align-items-center  ml-auto ml-md-0 ">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <div class="media align-items-center">
                                <span class="avatar avatar-sm rounded-circle">
                                    <img alt="Image placeholder" src="{{ 'images/admin/'.Auth::user()->photoName }}">
                                </span>
                        ...
                        <div class="dropdown-menu  dropdown-menu-right ">
                            ...
                            <a href="profilDoctor" class="dropdown-item">
...
<section id="profileUser" class="profile-area">
   <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-4 order-xl-2">
          <div class="card card-profile">
            <img src="{{ 'images/adminBg/'.Auth::user()->photoBgName }}" alt="Image placeholder" class="card-img-top">
            <div class="row justify-content-center">
              <div class="col-lg-3 order-lg-2">
                <div class="card-profile-image">
                  <a href="#">
                    <img src="{{ 'images/admin/'.Auth::user()->photoName }}" class="rounded-circle">
                  </a>
                </div>
              </div>
            </div>
            <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
              <div class="d-flex justify-content-between">
                <a href="#editProfile" class="btn btn-sm btn-info  mr-4">Edit Profile</a>
                <a href="#settingProfile" class="btn btn-sm btn-info  float-right">Settings</a>
              </div>
            </div>
...
<section id="editProfile" class="edit-user">
  <div class="container">
    <div class="card">
      ...
      <div class="card-body">
        <form>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" id="input-username" class="form-control" placeholder="Fullname">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input type="text" id="input-first-name" class="form-control" placeholder="Phone">
                </div>
              </div>
            </div>
          </div>
          ...
          <hr class="my-4">
          <!-- Description -->
          <h6 class="heading-small text-muted mb-4">Animals</h6>
          <div class="pl-lg-4">
            <div class="form-group">
              <label class="form-control-label">Animals</label>
...
<section id="settingProfile" class="setting-user">
  <div class="container">
    <div class="card">
      <div class="card-header">
        <div class="row align-items-center">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input id="input-password" class="form-control" placeholder="Password" type="password">
                </div>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="form-group">
                  ...
                  <input id="input-Newpassword" class="form-control" placeholder="New Password" type="password">
                </div>
              </div>
            </div>
          </div>
